...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">会议室预约网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!--  
                 ...
                 <li><a href="<%=basePath %>PayWay/frontlist">支付方式</a></li>
                 <li><a href="<%=basePath %>TimeInterval/frontlist">时段</a></li> -->
                 
                <li><a href="<%=basePath %>PlaceType/frontlist">会议室类型</a></li>
                <li><a href="<%=basePath %>Place/frontlist">会议室</a></li>
                <li><a href="<%=basePath %>OrderInfo/frontlist">订单记录</a></li> 
               
                <li><a href="<%=basePath %>Leaveword/frontlist">留言列表</a></li>
