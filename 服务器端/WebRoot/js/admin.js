		       ...
		       text: "会议室管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "PlaceType/placeType_add.jsp"
			    	   	},
			    		{
			    	   		text: "会议室类型管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "PlaceType/placeType_query_result.jsp"
			    	    },
			    	    {
			    		    text: "添加会议室",
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Place/place_add.jsp"
			    	   	},
			    		{
			    	   		text: "会议室管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Place/place_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "预约订单管理",
		       ...
		       text: "系统参数管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "PayWay/payWay_add.jsp"
			    	   	},
			    		{
			    	   		text: "支付方式管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "PayWay/payWay_query_result.jsp"
			    	    },
			    	    {
			    		    text: "添加时段",
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "TimeInterval/timeInterval_add.jsp"
			    	   	},
			    		{
			    	   		text: "时段管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "TimeInterval/timeInterval_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
