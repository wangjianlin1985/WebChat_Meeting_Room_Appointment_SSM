/*
 ...
 Source Schema         : place_order_db

 Target Server Type    : MySQL
 Target Server Version : 50620
 File Encoding         : 65001

 Date: 22/03/2021 12:27:31
*/
...
CREATE TABLE `t_place`  (
  ...
  `placeDesc` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '详细介绍',
...
-- Records of t_place
-- ----------------------------
INSERT INTO `t_place` VALUES (1, 1, 'HYS001', 'upload/ae621981-fa07-4521-90ab-d1904bee0f64.jpg', 50, '6A-101', 20, '小包间会议室，适合小组讨论', '2021-03-21 21:04:01');
INSERT INTO `t_place` VALUES (2, 3, '会议室202', 'upload/3611956f-c44e-4471-936f-1f94819ed236.jpg', 350, '6B-202', 30, '大型会议室，适合举办讲座', '2021-03-21 21:52:13');
INSERT INTO `t_place` VALUES (3, 2, '会议室206', 'upload/836606ac-38fb-4a1a-882b-6884fd75e733.jpg', 120, '6B-206', 25, '可以使用多媒体设备，适合学生上课，答辩等', '2021-03-22 12:15:31');
...
-- ----------------------------
INSERT INTO `t_userinfo` VALUES ('13590120934', '--', '牵着蜗牛去逛街', '男', '2021-03-21', 'upload/2d4c8e66-b19c-4c79-aa24-0aa2820b0616.jpg', '--', '--', '--', '2021-03-21 21:18:05', 'oM7Mu5XyeVJSc8roaUCRlcz_IP9k');
